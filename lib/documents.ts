...
export const publicDocuments: Record<string, PublicDocument> = {
  ...
  "irasbeli-tajekoztato": {
    ...
    sections: [
      { heading: "Képző szerv és ügyfélszolgálat", paragraphs: ["Képző szerv: Prémium Oktatás Kft. Székhely: 4551 Nyíregyháza, Trombita utca 12.", "Ügyfélfogadás: 4400 Nyíregyháza, Széchenyi utca 18. Telefon: +36/20-3-137-137. E-mail: info@premiumautosiskola.hu."] },
